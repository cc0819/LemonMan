...
public class Setting_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		install_protocol.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Setting_Activity.this, Protocol_Activity.class);
				startActivity(intent);
			}
		});
		...
		install_opinion.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Setting_Activity.this, Opinion_Activity.class);
				startActivity(intent);
			}
		});
		/**
		...
		install_memorys.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Toast.makeText(Setting_Activity.this, "清理成功",
		...
		install_update.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Toast.makeText(Setting_Activity.this, "超赞！您的版本已是最新版本",
						Toast.LENGTH_SHORT).show();
			}
		});
		...
		image_btn1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (flag) {
					image_btn.setImageResource(R.mipmap.ic_push_switch_close);
					flag = false;
				} else {
					image_btn.setImageResource(R.mipmap.ic_push_switch_open);
					flag = true;
				}
			}
		});
